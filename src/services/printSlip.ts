  ...
  <style>
    *{box-sizing:border-box}
    ...
    <div class="totals-area">
      <div class="words-box">
        ...
        <div style="margin-top:16px;font-size:10px;color:#475569;">
          ...
          ${s.bank || 'Meezan Bank Ltd | Posvibe Corporate Account'}
        </div>
    ...
    <div class="footer">
      ...
      <div style="margin-top:4px;font-weight:700;">Posvibe Multi-Store Invoicing & ERP System | Software Support: +92 308 6707676</div>
    </div>
  </div>
  </body></html>`;
